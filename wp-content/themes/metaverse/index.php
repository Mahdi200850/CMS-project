...
?>
	...
	<section id="section" class="section blog-grid blog
		<?php
		$metaverse_dark_theme_mode = get_theme_mod( 'formula_dark_theme_mode', true );
		if ( $metaverse_dark_theme_mode == false ) {
		?>
			theme-grey 
			<?php
		} else {
				...
				if ( have_posts() ) :
					...
					while ( have_posts() ) :
						...
						<div class="col-xl-6 col-lg-6">
							<?php
							$metaverse_blog_content_ordering = get_theme_mod( 'formula_blog_content_ordering', array( 'meta-one', 'title', 'meta-two' ) );
							?>
							<!--content.php-->
							<article id="main-content" class="post">					
								...
								<div class="blog-head">
									...
									<?php foreach ( $metaverse_blog_content_ordering as $metaverse_blog_content_order ) : ?>
										<?php if ( 'meta-one' === $metaverse_blog_content_order ) : ?>
											<div class="entry-meta">
												<span class="byline"><?php esc_html_e( 'By', 'metaverse' ); ?>
										...
										<?php elseif ( 'title' === $metaverse_blog_content_order ) : ?>
